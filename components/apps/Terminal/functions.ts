...
export const commands: Record<string, string> = {
  ...
  projects: "Show portfolio projects and demos.",
...
export const aliases: Record<string, string[]> = {
  about: ["bio", "story", "background"],
  cd: ["chdir"],
  clear: ["cls"],
  contact: ["info", "reach", "connect"],
  copy: ["cp"],
  del: ["erase"],
  dir: ["ls"],
  exit: ["quit"],
  find: ["search"],
  git: ["isogit"],
  "hire-me": ["hire", "work-with-me", "why-hire"],
  ...
  services: ["pricing", "rates", "costs"],
  sheep: ["esheep"],
  shutdown: ["logout", "restart"],
  skills: ["skill", "tech", "technologies"],
  taqyudin: ["help-me", "assistant", "guide"],
  taskkill: ["kill"],
  tasklist: ["ps"],
  type: ["cat"],
  ver: ["version"],
